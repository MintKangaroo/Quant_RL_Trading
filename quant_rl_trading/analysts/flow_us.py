...
**실측 — 기각 (2026-09-02).** 508세션 채점, 월말 시점 11개(시점당 300일)에서 IC
−0.0105 ~ −0.0246, 전부 음수. 등록 부호와 반대다 — 이 구간에선 잔고가 큰 종목이
뒤에 더 올랐다. 부호는 사후에 안 뒤집는다. 가중치 0(관찰 모드) 유지, 피처는 남긴다 —
"부호 +" 는 새 등록의 몫이고 그때 시가총액·베타 잔차화부터 본다.
"""
