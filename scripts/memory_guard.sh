...
VICTIMS=(
  ...
  "trial_(beta|index|overlay|cap|market|ranker_ens|ranker_target|ranker_market|regime|reverse|collapse|uncertainty|us_index|us_missing|us_selection|us_index_tilt|portfolio|rebalance|lambdarank|temporal|insider)[a-z_]*\.p[y]"
